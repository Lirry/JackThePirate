 ...
 *
 * The red feather is defined using Box2D
 */

public class FeatherRed extends Sprite {
    public World world;
    public Body b2body;
    public Texture featherSprite;


    public FeatherRed(World world){
        // Place feather in world context
        this.world = world;
        defineFeather();

        // Use png file for sprite
        featherSprite = new Texture("feather_red.png");
    ...
    public void defineFeather(){
        ...
        fdef.shape = shape;
        b2body.createFixture(fdef).setUserData("feather_red");
